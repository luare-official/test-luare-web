    ...
    <section className="relative flex items-center justify-start overflow-hidden min-h-[640px] h-auto lg:h-[calc(100vh-80px)] w-full bg-brand-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] w-full px-6 sm:px-12 md:px-20 py-20 sm:py-28 lg:pt-[220px] lg:pb-32">
        <div className="fade-in-section">
          ...
          {/* Main Copy */}
          <h1 className="max-w-[860px] font-serif text-[1.75rem] sm:text-4xl lg:text-5xl xl:text-[3.5rem] font-medium tracking-wide text-brand-navy leading-[1.4] mb-8 sm:mb-12">
          ...
          <div className="relative pl-6 sm:pl-10 mb-10 sm:mb-12 max-w-[620px] flex flex-col gap-6 sm:gap-8">
            ...
            <div className="flex items-start gap-4 sm:gap-5">
              ...
              <p className="text-base sm:text-[1.1rem] text-brand-slate leading-[1.8] tracking-wide">
                ...
                <span className="text-brand-gold font-bold">人材コスト</span>。
                経理・財務部門が抱える課題を、AIと財務専門家の力で解決します。
              </p>
            </div>
            ...
            <div className="flex items-start gap-4 sm:gap-5">
              ...
              <p className="text-base sm:text-[1.1rem] text-brand-slate leading-[1.8] tracking-wide">
                国内企業・外資系企業向けに、持続可能な財務体制の構築と運営を支援します。
              </p>
            </div>
          </div>
