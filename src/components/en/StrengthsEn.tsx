export default function StrengthsEn() {
  const strengths = [
    {
      title: "Zero Local Hiring Risk",
      subtitle: "SUSTAINABLE SYSTEM",
      desc: "Skip recruitment delays, visa issues, and sudden turnover risks in Japan. We provide a fully standardized, team-backed local accounting operation.",
      icon: (
    ...
    {
      title: "100% Secure Local AI",
      subtitle: "EMPOWER YOUR SYSTEM",
      desc: "No cloud data leaks. We leverage highly secure local AI agents trained directly on J-GAAP compliance, invoice reading, and Japanese tax laws.",
      icon: (
        <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "Big 4 Quality at Optimized Cost",
      subtitle: "TOP-TIER EXPERTISE",
      desc: "Get premium audit-ready reporting and J-GAAP to US-GAAP/IFRS standard conversions overseen by USCPA and bilingual experts without Big 4 premium fees.",
      icon: (
        <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: "T+1 Financial Visibility",
      subtitle: "HIGH-SPEED TURNAROUND",
      desc: "Real-time updates and fast monthly closing pipelines that keep your global parent CFO and executive dashboard updated without delays.",
      icon: (
        <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16 md:mb-24">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-medium tracking-wide text-brand-charcoal mt-4 leading-tight">
            Why Luare is Chosen as the Local Partner
          </h2>
        </div>
